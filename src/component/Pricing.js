    ...
    <ul>
     ...
     <button onClick={confirmationtwo} className={PricingStyle.btn}>Subscribe</button>}
      ...
      <div className={PricingStyle.content}>
        <h4 style={{ fontFamily: "Colonna MT" ,textShadow: "2px 2px black"}}>Membership</h4>
        <h2 style={{ fontFamily: "Colonna MT" ,textShadow: "2px 2px black"}}>From Punch Pass to Monthly or Annual</h2>
